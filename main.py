...
from torsomaxsat import CyLPSolver
...
if __name__ == "__main__":
    ...
    parser.add_argument("-s", "--solver", choices=["gurobi", "scip", "rc2", "fm", "ortools", "coinor", "dp"], help="Base solvered used.", default="rc2")
    ...
    if args.solver == "gurobi":
        ...
        solver = ORSolver(phi)
    elif args.solver == "coinor":
        solver = CyLPSolver(phi)
    elif args.solver == "dp":
        solver = DPSolver(phi)
